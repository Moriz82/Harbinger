...
The checked-in set uses synthetic data. It covers the map and finding editor at 1366 x 768 and 1920 x 1080. Verify each file against `MANIFEST.json` before release.
