...
Checked 2026-09-08 against `package-lock.json` and installed package metadata. Versions below are the exact resolved direct packages. The lock file records their transitive dependencies.
...
| cytoscape | 3.31.2 | MIT | Relationship map |
| @types/cytoscape | 3.21.9 | MIT | Map type declarations |

No Hawkeye or Gossamer code is included. Their pinned main revisions are MIT design references only; see [the root inventory](../THIRD-PARTY.md).
